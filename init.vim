...
func MPI_cpp_Init()
	normal gg
	normal dG
	0r ~/.config/nvim/template/mpi.cpp
	normal 29G
endfunc
func Gen_sh_Init()
	0r ~/.config/nvim/template/gen.sh
endfunc
func Make_cpp_Init()
	0r ~/.config/nvim/template/make.cpp
endfunc
func CppInit()
	0r ~/.config/nvim/template/cpp.cpp
endfunc
func Init_cpp()
	if expand('%')=="make.cpp"
		exec ":call Make_cpp_Init()"
	else
		exec ":call CppInit()"
	endif
endfunc
autocmd BufNewFile gen.sh exec ":call Gen_sh_Init()"
